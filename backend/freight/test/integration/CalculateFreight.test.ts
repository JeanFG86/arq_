...
describe("Calculate Freight", () => {
  it.skip("Deve calcular o frete para um pedido sem CEP de origem e destino", async () => {
  ...
  it.skip("Deve calcular o frete para um pedido com CEP de origem e destino usando um fake", async () => {
    // const connection = new PgPromiseConnection();
    // const productData = new ProductDataDatabase(connection);
    // const zipcodeData: ZipcodeData = {
    //   async get(code: string): Promise<Zipcode | undefined> {
